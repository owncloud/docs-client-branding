...
:toc: right
:oc-web-manual-url: https://doc.owncloud.com/webui/next/classic_ui/files/webgui/sharing.html
...
Simply upload it to your ownCloud server and share it like any other file: you can create normal ownCloud shares with ownCloud users and groups, and you may create a link share to share it with anyone. (See the *Sharing Files* section of the {oc-user-manual-url}[ownCloud Web Manual] to learn more about sharing files.)
